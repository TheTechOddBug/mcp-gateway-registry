...
```bash
docker pull mcpgateway/registry:1.26.0
docker pull mcpgateway/auth-server:1.26.0
docker pull mcpgateway/currenttime-server:1.26.0
docker pull mcpgateway/realserverfaketools-server:1.26.0
docker pull mcpgateway/mcpgw-server:1.26.0
docker pull mcpgateway/metrics-service:1.26.0
```
